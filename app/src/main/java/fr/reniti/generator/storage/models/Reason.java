...
*/
   /* TRAVAIL(R.string.reason_travail, AttestationType.CONFINEMENT, 553, "travail", R.string.activity_attestation_create_reason_travail, R.drawable.ic_baseline_work_16),
    ...
    CF_TRAVAIL(R.string.reason_travail, AttestationType.COUVRE_FEU, 579, "travail", R.string.activity_attestation_create_reason_cf_travail, R.drawable.ic_baseline_work_16_orange),
    CF_SANTE(R.string.reason_sante, AttestationType.COUVRE_FEU, 546, "sante", R.string.activity_attestation_create_reason_cf_sante, R.drawable.ic_baseline_local_hospital_16_orange),
    CF_FAMILLE(R.string.reason_famille, AttestationType.COUVRE_FEU, 512, "famille", R.string.activity_attestation_create_reason_cf_famille, R.drawable.ic_baseline_family_restroom_16_orange),
    CF_HANDICAP(R.string.reason_handicap, AttestationType.COUVRE_FEU, 478, "handicap", R.string.activity_attestation_create_reason_cf_handicap, R.drawable.ic_baseline_accessible_16_orange),
    CF_CONVOCATION(R.string.reason_convocation, AttestationType.COUVRE_FEU, 459, "judiciaire", R.string.activity_attestation_create_reason_cf_convocation, R.drawable.ic_baseline_assignment_16_orange),
    CF_MISSIONS(R.string.reason_missions, AttestationType.COUVRE_FEU, 438, "missions", R.string.activity_attestation_create_reason_cf_missions, R.drawable.ic_baseline_engineering_16_orange),
    CF_TRANSITS(R.string.reason_transits, AttestationType.COUVRE_FEU, 404, "transits", R.string.activity_attestation_create_reason_cf_transits, R.drawable.ic_baseline_train_16_orange),
    CF_ANIMAUX(R.string.reason_animaux, AttestationType.COUVRE_FEU, 370, "animaux", R.string.activity_attestation_create_reason_cf_animaux, R.drawable.ic_baseline_pets_16_orange),
