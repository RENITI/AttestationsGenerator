...
*/
    ...
    CF_TRAVAIL("Travail", AttestationType.COUVRE_FEU, 540, "travail", R.string.activity_attestation_create_reason_cf_travail, R.drawable.ic_baseline_work_16_orange),
    CF_SANTE("Santé", AttestationType.COUVRE_FEU, 508, "sante", R.string.activity_attestation_create_reason_cf_sante, R.drawable.ic_baseline_local_hospital_16_orange),
    CF_FAMILLE("Famille", AttestationType.COUVRE_FEU, 474, "famille", R.string.activity_attestation_create_reason_cf_famille, R.drawable.ic_baseline_family_restroom_16_orange),
    CF_HANDICAP("Handicap", AttestationType.COUVRE_FEU, 441, "handicap", R.string.activity_attestation_create_reason_cf_handicap, R.drawable.ic_baseline_accessible_16_orange),
    CF_CONVOCATION("Convocation", AttestationType.COUVRE_FEU, 418, "convocation", R.string.activity_attestation_create_reason_cf_convocation, R.drawable.ic_baseline_assignment_16_orange),
    CF_MISSIONS("Missions", AttestationType.COUVRE_FEU, 397, "missions", R.string.activity_attestation_create_reason_cf_missions, R.drawable.ic_baseline_engineering_16_orange),
    CF_TRANSITS("Transits", AttestationType.COUVRE_FEU, 363, "transits", R.string.activity_attestation_create_reason_cf_transits, R.drawable.ic_baseline_train_16_orange),
    CF_ANIMAUX("Animaux", AttestationType.COUVRE_FEU, 330, "animaux", R.string.activity_attestation_create_reason_cf_animaux, R.drawable.ic_baseline_pets_16_orange);
